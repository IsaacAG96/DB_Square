        ...
        <div class="flex justify-center">
            <div class="p-6 lg:p-8 grid grid-cols-1 gap-6 mt-6 w-full max-w-7xl">
                <div class="bg-white shadow-md rounded-lg p-4 lg:p-10 mx-auto w-full">
                    ...
                    <nav class="mb-4 text-sm text-gray-700" aria-label="Breadcrumb">
                        <ol class="list-none p-0 inline-flex">
                            <li class="flex items-center">
                                <a href="{{ route('inicio') }}" class="text-blue-500 hover:text-blue-700">{{ __('Home') }}</a>
                            ...
                            <li class="flex items-center">
                                <span class="text-gray-700">{{ __('Options Menu') }}</span>
                            </li>
                        </ol>
                    </nav>
                    <!-- End of Breadcrumbs -->

                    <h3 class="text-2xl font-semibold text-gray-900 mb-4">{{ __('Options Menu') }}</h3>
                    ...
                    <a href="{{ route('menu.crear') }}" class="block bg-gray-100 py-4 px-12 rounded hover:bg-indigo-400 transition duration-150 mb-4">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="ms-1 w-5 h-5">
