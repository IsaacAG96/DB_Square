    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-16 w-auto bg-gray-100">
            ...
            <div class="mt-16">
                <div class="text-center">
                    <h1 class="text-4xl font-bold text-gray-900">Bienvenido a DB SQUARE</h1>
                    <p class="mt-4 text-gray-500 text-lg">Tu solución integral para la creación y gestión de bases de datos.</p>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            ...
                            <div>
                                <div class="h-16 w-16 bg-red-50 flex items-center justify-center rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-7 h-7 stroke-red-500">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0166 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                                    </svg>
                                </div>

                                <h2 class="mt-6 text-xl font-semibold text-gray-900">Crear Bases de Datos</h2>

                                <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                                    Con DB SQUARE, puedes crear bases de datos fácilmente con una interfaz intuitiva y amigable.
                                </p>
                            </div>
                        ...
                        <a href="#" class="scale-100 p-6 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900">Gestión de Bases de Datos</h2>

                                <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                                    Administra tus bases de datos con herramientas poderosas y flexibles que te permiten optimizar y mantener tu información segura.
                                </p>
                            </div>
                        ...
                        <a href="#" class="scale-100 p-6 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                                    Consulta nuestra documentación completa para aprovechar al máximo todas las funcionalidades de DB SQUARE.
                                </p>
                            </div>
                        ...
                        <div class="scale-100 p-6 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900">Ecosistema Vibrante</h2>

                                <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                                    DB SQUARE forma parte de un ecosistema vibrante de herramientas y bibliotecas que te ayudan a llevar tus proyectos al siguiente nivel.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                ...
                <div class="text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                    DB SQUARE © 2024 - Todos los derechos reservados
                </div>
            </div>
        </div>
    </div>
