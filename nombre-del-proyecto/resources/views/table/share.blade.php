            ...
            <div class="bg-white shadow-md rounded-lg p-6 lg:p-8 mx-auto w-full max-w-7xl">
                ...
                <nav class="mb-4 text-sm text-gray-700" aria-label="Breadcrumb">
                    <ol class="list-none p-0 inline-flex">
                        ...
                        <li class="flex items-center">
                            <span class="text-gray-700">{{__('Share')}}</span>
                        </li>
                    </ol>
                </nav>
                <!-- Fin de migas de pan -->
                    ...
                    <div class="mt-10 overflow-x-auto">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 mt-4 border">
                            <thead class="bg-gray-100">
                                <tr>
                                    <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">{{__('User ID')}}</th>
                                    <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">{{__('User Name')}}</th>
                                    <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">{{__('Shared Table Name')}}</th>
                                    <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">{{__('Permission')}}</th>
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">{{__('Share by Email')}}</h3>
                        <div class="mt-2">
                            <form action="{{ route('table.sendEmail', ['table' => $table]) }}" method="POST">
                                ...
                                <div class="flex justify-end">
                                    <button type="button" class="inline-flex items-center px-4 py-2 bg-gray-200 text-gray-600 hover:bg-gray-300 transition duration-150 rounded-md mr-2" onclick="document.getElementById('emailModal').classList.add('hidden');">{{__('Cancel')}}</button>
                                    <button type="submit" class="inline-flex items-center px-4 py-2 bg-blue-200 text-blue-600 hover:bg-blue-300 transition duration-150 rounded-md">{{__('Send')}}</button>
                                </div>
                            </form>
                        </div>
                    </div>
