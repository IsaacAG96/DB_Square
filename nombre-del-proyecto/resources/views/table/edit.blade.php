        ...
        <div class="bg-white shadow-md rounded-lg p-6 mx-auto w-full max-w-7xl">
            ...
            <nav class="mb-4 text-sm text-gray-700" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex">
                    ...
                    <li class="flex items-center">
                        <a href="{{ route('table.edit', ['table' => $table]) }}" class="text-blue-500 hover:text-blue-700">{{__('Edit')}} {{ str_replace('_', ' ', $table) }}</a>
                    </li>
                </ol>
            </nav>
            <!-- Fin de migas de pan -->
            <div class="mb-4 flex justify-between items-center">
                <h3 class="text-xl font-semibold text-gray-900">{{__('Edit')}} <span class="uppercase">{{ str_replace('_', ' ', $table) }}</span></h3>
